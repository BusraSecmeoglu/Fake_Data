...
namespace SahteVeri.Gruplar
{
     ...
     public  class AdresUretim
    {
        ...
        private Country[] countries =
        {
            ...
            new Country {CountryName = "France", Cities = new[] {"Paris", "Marseille", "Nantes"}},
            new Country {CountryName = "Japan", Cities = new[] {"Tokio", "Hiroshima"}},
            new Country {CountryName = "Russia", Cities = new[] {"Moscow"}},
            new Country {CountryName = "England", Cities = new[] { "Manchester", "London"}}
        };
